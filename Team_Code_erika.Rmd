...
ushousehold%>%ggplot(aes(year1)) + geom_point( aes(y=single_householdpct, color = " % single_household")) +geom_point( aes(y=housepct, color = "%couples households")) + geom_point(aes(y=rapepct, color = "%Rape")) +geom_point( aes(y=murderpct, color = "% Murder"))  +labs(title="Rape and Murder vs Single and Couple households", y = "Rate per 100k", col="Values", x="year")
