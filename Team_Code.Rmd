...
In this next part, we explore a number of factors that could contribute to a high incidence of rape. A similar format is used to compare the factor against the rate of murder. 
