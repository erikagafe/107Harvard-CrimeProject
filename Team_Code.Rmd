...
We assume that single parent families would have higher crime rate overall than nuclear family systems, lets see if the data supports that theory.The graphs below only takes into account single male and single female households and compares it to rape and murder rates.
...
Now will look to see if a particular race is more prominent in crime areas. If immigration (non-white population) impacts crime rates. Our assumption is, the more immigration (non-white) population that enters the USA the lesser the crime rates. Lets see if this assumption holds:
...
lets now compare medan income to crime rate, do they have a similar trend like income disparity did on crime. Lets see:
