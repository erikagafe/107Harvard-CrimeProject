...
stdem %>% ggplot(aes(x = tot_pop/100000,y = State)) + geom_point()
stdem %>% ggplot(aes(x = num_rapes/tot_pop * 100000,y = State)) + geom_point()
stdem %>% ggplot(aes(x = num_murder/tot_pop * 100000,y = State)) + geom_point()
