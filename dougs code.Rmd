...
This document contains the code I am using to manipulate the demographic and crime files. Starting with U.S. census bureau data to put together a working table for national population and looking a historical approach - how things changed over time. 

Some focusing questions:
1. Is the prevelance of a traditional household an influence on violent crime? 
2. Is income level an influence on violent crime? 
3. Is racial mix an influence on viloent crime? 


I suppose an alternate (or complementary) approach would be comparing the current state of country or city 1 to country and city 2.
